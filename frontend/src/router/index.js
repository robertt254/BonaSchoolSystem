    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: 'petty-cash',
          component: () => import('../views/Finance/PettyCashPage.vue'),
          meta: { requiresAuth: true, roles: ['accountant', 'principal', 'admin'] },
        },
        {
          path: 'finance/budget',
        ...
        },
        {
          ...
          name: 'promotion',
          component: () => import('../views/Admin/PromotionPage.vue'),
          meta: { requiresAuth: true, roles: ['principal', 'admin'] },
        },
        {
          path: 'admin/year-transition',
          name: 'year-transition',
          component: () => import('../views/Admin/YearTransition.vue'),
          meta: { requiresAuth: true, roles: ['admin', 'principal'] },
        },
        {
          path: 'admin/reports',
          name: 'reports',
          component: () => import('../views/Admin/ReportBuilder.vue'),
          meta: { requiresAuth: true, roles: ['principal', 'admin'] },
        },
      ],
    },
