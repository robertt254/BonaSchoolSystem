...
const allMenuItems = [
  ...
  { name: 'Office & Admissions', path: '/app/office', roles: ['admin', 'principal', 'secretary'], icon: '🏢' },
  { name: 'Finance & Fees', path: '/app/finance', roles: ['admin', 'accountant', 'principal'], icon: '💰' },
  { name: 'Academics & Grading', path: '/app/academics', roles: ['admin', 'principal', 'senior_teacher'], icon: '📚' }
]
  ...
  <div class="flex h-screen bg-bona-bg font-sans overflow-hidden">
    ...
    >
      ...
      <div class="p-4 border-t border-blue-800">
        <button @click="handleLogout" class="flex items-center gap-3 w-full px-4 py-2 text-sm font-medium text-blue-200 rounded-lg hover:bg-bona-red hover:text-white transition-colors">
    ...
    <div class="flex-1 flex flex-col min-w-0">
      ...
      <!-- TOP NAVIGATION BAR -->
      <header class="bg-bona-white shadow-sm h-16 flex items-center justify-between px-4 sm:px-6 z-10">

        <!-- Mobile Menu Button -->
        <button @click="isSidebarOpen = true" class="md:hidden text-slate-500 hover:text-slate-700 focus:outline-none">
        ...
        <div class="flex items-center gap-4 ml-auto">
          ...
          <!-- Avatar -->
          <div class="h-10 w-10 rounded-full bg-bona-navy flex items-center justify-center text-white font-bold shadow-md ring-2 ring-blue-100">
            AU
          </div>
        </div>
      </header>
