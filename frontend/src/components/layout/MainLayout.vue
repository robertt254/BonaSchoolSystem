    ...
    <div class="flex-1 flex flex-col min-w-0 bg-slate-50">
      ...
      >
        ...
        <div class="hidden md:flex flex-col">
          <div class="flex items-center gap-2 text-sm text-slate-400 font-medium mb-0.5">
            <span>Dashboard</span>
            ...
            <span class="text-school-navy">Overview</span>
          </div>
          <h2 class="text-2xl font-bold text-slate-900 tracking-tight leading-none">
            System Overview
          </h2>
        </div>
        ...
        <div class="flex items-center gap-6 ml-auto">
          ...
          <div class="hidden lg:flex items-center relative">
            <svg
              class="w-5 h-5 text-slate-400 absolute left-3"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <input
              ...
              class="pl-10 pr-4 py-2 border border-slate-200 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-school-navy/20 focus:border-school-navy w-64 bg-slate-50/50 transition-all"
            />
          </div>

          <!-- Notification Bell -->
          <button
            class="relative text-slate-400 hover:text-slate-600 transition-colors focus:outline-none"
          >
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                stroke-linecap="round"
            ...
            <span
              class="absolute top-0 right-0 block h-2.5 w-2.5 rounded-full bg-school-red ring-2 ring-white"
            ></span>
          </button>
