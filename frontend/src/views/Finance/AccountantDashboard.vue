      ...
      <table class="w-full text-left border-collapse">
        ...
        <tbody class="text-gray-700">
          ...
          >
            ...
            <td class="p-4 text-right font-bold text-emerald-700">{{ formatCurrency(fee.amount) }}</td>
      ...
      <div class="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden">
        ...
        <form @submit.prevent="submitFee" class="p-6 space-y-4">
          <div>
            ...
            <select v-model="formData.student_id" required class="w-full border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-emerald-600 outline-none">
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              ...
              <select v-model="formData.payment_type" required class="w-full border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-emerald-600 outline-none">
            ...
            <div>
              ...
              <input v-model.number="formData.amount" type="number" step="0.01" min="0" required class="w-full border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-emerald-600 outline-none">
            </div>
          </div>

          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Term</label>
            <select v-model="formData.term" required class="w-full border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-emerald-600 outline-none">
          ...
          <div class="flex justify-end space-x-3 pt-4 border-t border-gray-100 mt-6">
            ...
            <button type="submit" class="px-4 py-2 bg-emerald-700 text-white rounded-lg font-medium hover:bg-emerald-600 transition">Save Payment</button>
          </div>
        </form>
      </div>
    </div>
