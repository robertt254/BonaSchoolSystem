<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
    ...
    <div class="mb-8">
      ...
      <p class="text-[13px] text-[#94A3B8] mt-1">System overview, user activity, and live metrics.</p>
    </div>
    ...
    <template v-else>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        <!-- Total Students -->
        <div class="bg-white p-6 rounded-[12px] border border-[#E2E8F0] hover:shadow-md transition-shadow relative overflow-hidden group">
          ...
          <div class="flex justify-between items-start relative z-10">
            <div>
              <div class="text-[11px] font-bold uppercase tracking-[0.07em] text-[#94A3B8] mb-1">Total Students</div>
              <div class="text-3xl font-extrabold text-slate-800">{{ stats.total_students }}</div>
            </div>
            <div class="p-2.5 bg-blue-100/50 text-blue-600 rounded-[10px]">
        ...
        <div class="bg-white p-6 rounded-[12px] border border-[#E2E8F0] hover:shadow-md transition-shadow relative overflow-hidden group">
          ...
          <div class="flex justify-between items-start relative z-10">
            <div>
              <div class="text-[11px] font-bold uppercase tracking-[0.07em] text-[#94A3B8] mb-1">Active Staff</div>
              <div class="text-3xl font-extrabold text-slate-800">{{ stats.total_staff }}</div>
            </div>
            <div class="p-2.5 bg-violet-100/50 text-school-purple rounded-[10px]">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white p-6 rounded-[12px] border border-[#E2E8F0] hover:shadow-md transition-shadow relative overflow-hidden group">
          ...
          <div class="flex justify-between items-start relative z-10">
            <div>
              <div class="text-[11px] font-bold uppercase tracking-[0.07em] text-[#94A3B8] mb-1">Total Revenue</div>
              <div class="text-2xl font-extrabold text-emerald-600">{{ formatCurrency(stats.total_revenue) }}</div>
            </div>
            <div class="p-2.5 bg-emerald-100/50 text-emerald-600 rounded-[10px]">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white p-6 rounded-[12px] border border-[#E2E8F0] hover:shadow-md transition-shadow relative overflow-hidden group">
          ...
          <div class="flex justify-between items-start relative z-10">
            <div>
              <div class="text-[11px] font-bold uppercase tracking-[0.07em] text-[#94A3B8] mb-1">System Status</div>
      ...
      <div class="bg-white rounded-[12px] border border-[#E2E8F0] overflow-hidden">
        <div class="border-b border-slate-100 px-8 py-5 flex items-center justify-between bg-slate-50">
          ...
          <span class="text-[11px] font-bold uppercase tracking-widest text-slate-400">Audit Log</span>
        </div>
        ...
        <div v-else class="divide-y divide-slate-50">
          ...
          >
            <div
              class="w-9 h-9 rounded-full flex items-center justify-center font-bold text-[13px] shrink-0 mt-0.5"
            ...
            <span
              class="text-[10px] font-bold uppercase px-2 py-0.5 rounded-full shrink-0 mt-0.5"
